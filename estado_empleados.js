document.addEventListener('DOMContentLoaded', function() {
    ...
    const empleado = {
        ...
        estadoCuenta: 'Activa', // Estado de la cuenta
        prestamoPendiente: 'Sí' // Préstamo pendiente
    };
    ...
    function mostrarInformacionEmpleado() {
        ...
        document.getElementById('estadoCuenta').textContent = empleado.estadoCuenta;
        document.getElementById('prestamoPendiente').textContent = empleado.prestamoPendiente;
    }
...
document.addEventListener('DOMContentLoaded', function() {
    console.log('Sección de Estado de Empleados cargada.');
